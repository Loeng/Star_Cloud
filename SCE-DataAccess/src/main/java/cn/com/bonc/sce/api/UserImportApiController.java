...
@Slf4j
@RestController
@RequestMapping( "/user-info-upload" )
public class UserImportApiController {
    ...
    @Autowired
    public UserImportApiController( FileResourceRepository fileResourceRepository, UserPasswordDao userPasswordDao, ExportUserRepository exportUserRepository, MessageService messageService ) {
                ...
                for ( ; i < list.size(); i++ ) {
                    ...
                    if ( excelToUser.getUserName() == null ) {
                        continue;
                            ...
                            excelToUser.getTeachRange() == null || excelToUser.getCertificateType() == null || excelToUser.getOrganizationId() == null ) {
                        log.info( "缺少必填项" );
