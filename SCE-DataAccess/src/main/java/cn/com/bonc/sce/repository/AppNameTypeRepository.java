...
public interface AppNameTypeRepository extends JpaRepository< AppInfoEntity, String > {
    ...
    @Query( value = "SELECT MAIN.*,A5.APP_TYPE_NAME,A4.COMPANY_NAME FROM\n" +
            ...
            " INNER JOIN ( SELECT DISTINCT AVB.APP_ID, MAX( AVB.CREATE_TIME ) CREATE_TIME FROM STARCLOUDMARKET.SCE_MARKET_APP_VERSION AVB  WHERE AVB.APP_STATUS='4' AND AVB.IS_DELETE=1 GROUP BY AVB.APP_ID ) \n" +
            " TEMPA ON MAIN.APP_ID = TEMPA.APP_ID \n" +
