...
public interface AgentRepository extends JpaRepository< Agent, String > {
     ...
     * @return
     */
    @Query(value="SELECT A.AGENT_AREA,A.GRADE,A.ESTABLISHING_TIME,A.JURIDICAL_PERSON,A.AGENT_REGISTATION_ID,A.AGENT_INTRODUCTION,A.AGENT_ADDRESS,A.AGENT_TAX_NUM,A.AGENT_WEBSITE,A.ID," +
