...
public interface InstitutionMapper {
    ...
    int addInstitution(@Param("id") Long id,@Param("institution_name") String institution_name,@Param("address") String address,
                       ...
                       @Param("userId") String userId,@Param("roleId") Integer roleId);
