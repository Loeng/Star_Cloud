...
public class MarketAppController {
    ...
    @ApiImplicitParams( {
            @ApiImplicitParam( name = "appIdList", value = "appId", paramType = "head", required = true )
    } )
    @ApiResponses( {
            @ApiResponse( code = 0, message = "成功", response = RestRecord.class )
    } )
    ...
    @ApiImplicitParams( {
            @ApiImplicitParam( name = "appId", value = "appid", paramType = "head", required = true ),
    ...
    @ApiImplicitParams( {
            @ApiImplicitParam( name = "plantformType", value = "应用类型(平台应用pt|软件应用rj)", paramType = "head", required = true )
    ...
    @ApiImplicitParams( {
            @ApiImplicitParam( name = "appName", value = "appName", paramType = "head", required = true ),
            @ApiImplicitParam( name = "plantformType", value = "应用类型(平台应用|软件应用)", paramType = "head", required = true )
    ...
    @ApiImplicitParams( {
            @ApiImplicitParam( name = "appName", value = "appName", paramType = "head", required = true ),
            @ApiImplicitParam( name = "appType", value = "appType", paramType = "head", required = true ),
            @ApiImplicitParam( name = "orderType", value = "orderType", paramType = "head", required = false ),
            @ApiImplicitParam( name = "plantformType", value = "应用类型(平台应用|软件应用)", paramType = "head", required = true )
