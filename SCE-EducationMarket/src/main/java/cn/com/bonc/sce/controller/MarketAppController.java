...
public class MarketAppController {
    ...
    @ApiImplicitParams( {
            @ApiImplicitParam( name = "appIdList", value = "appId", paramType = "header", required = true )
    } )
    @ApiResponses( {
            @ApiResponse( code = 0, message = "成功", response = RestRecord.class )
    } )
    ...
    @ApiImplicitParams( {
            @ApiImplicitParam( name = "appId", value = "appid", paramType = "header", required = true ),
            @ApiImplicitParam( name = "updateInfo", value = "app修改的信息", paramType = "body", required = true )
    ...
    @ApiImplicitParams( {
            @ApiImplicitParam( name = "plantformType", value = "应用类型(平台应用pt|软件应用rj)", paramType = "header", required = true )
    ...
    @ApiImplicitParams( {
            @ApiImplicitParam( name = "appType", value = "查询的应用类型（all,教学类,教辅类,管理类，其它...）", paramType = "body", required = false ),
            @ApiImplicitParam( name = "orderType", value = "查询排序字段，可为多个字段(上架时间，下载量...)", paramType = "body", required = false ),
            @ApiImplicitParam( name = "plantformType", value = "应用类型(平台应用pt|软件应用rj)", paramType = "body", required = true )
    ...
    @ApiImplicitParams( {
            @ApiImplicitParam( name = "appName", value = "appName", paramType = "header", required = true ),
            @ApiImplicitParam( name = "plantformType", value = "应用类型(平台应用|软件应用)", paramType = "header", required = true )
    ...
    @ApiImplicitParams( {
            @ApiImplicitParam( name = "appName", value = "appName", paramType = "header", required = true ),
            @ApiImplicitParam( name = "appType", value = "appType", paramType = "header", required = true ),
            @ApiImplicitParam( name = "orderType", value = "orderType", paramType = "header", required = false ),
            @ApiImplicitParam( name = "plantformType", value = "应用类型(平台应用|软件应用)", paramType = "header", required = true )
    ...
    @ApiImplicitParams( {
            ...
            @ApiImplicitParam( name = "userId", value = "userId", paramType = "body", required = true )
